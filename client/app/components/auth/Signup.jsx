...
export default function Signup() {
  ...
  password: formData.password,
      ...
      // Check for success (standardizing based on your second snippet)
      if (res.data && res.data.success) {
        // Step 2: Store form data temporarily to use after OTP verification
      ...
      setError(err.response?.data?.message || 'An error occurred while sending OTP. Please try again.');
