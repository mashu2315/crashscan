...
import { inspectionEndpoints } from "@/lib/endpoints"

// UPLOAD IMAGE
export const uploadInspectionService = (formData) => {
  return apiConnector(
    "POST",
    inspectionEndpoints.UPLOAD_INSPECTION,
    formData,
...
// GET HISTORY
export const getInspectionHistoryService = () => {
  return apiConnector(
    "GET",
    inspectionEndpoints.GET_HISTORY,
    null,
...
// DELETE RECORD
export const deleteInspectionRecordService = (id) => {
  return apiConnector(
    "DELETE",
    inspectionEndpoints.DELETE_RECORD + id,
    null,
...
// UPDATE REMARKS
export const updateInspectionRemarksService = (id, remarks) => {
  return apiConnector(
    "PUT",
    inspectionEndpoints.UPDATE_REMARKS + id,
    { remarks },
